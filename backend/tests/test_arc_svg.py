...
def trace_to_svg(image_path, epsilon_val=0.1, tol=1.5):
    ...
    for cnt in contours:
        ...
        while i < n - 1:
            ...
            if best_k >= 3 and best_arc:
                ...
                # SVG Arc Command: A rx ry x-axis-rotation large-arc sweep x y
        ...
        # path_d += "Z" # we already closed loop via appending points[0]
        svg_paths.append(path_d)
        
    print(f"Total arcs found: {arcs_found}")
    return svg_paths
